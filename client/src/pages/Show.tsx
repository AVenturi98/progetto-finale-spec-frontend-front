...
export default function Show() {
    ...
    return (
        <div className='flex justify-center items-center'>
            {record ?
                <div className='m-12 w-full border-2 border-gray-500 rounded-md flex flex-col gap-2 py-5 px-18'>
                    <div className='flex flex-row-reverse justify-between items-center'>
                        <h2 className='w-[30%] text-center'><span className='text-sm'>A:</span> {record.title && record.title}</h2>
                        <div>{record.available ?
                            <p className='text-green-500'>Disponibile</p> :
                            <p className='text-red-500'>Non disponibile</p>}
                        </div>
                        <h2 className='w-[30%] text-center'><span className='text-sm'>Da:</span> {record.start && record.start}</h2>
                    </div>
                    <div className='flex justify-center items-center'>
                    ...
                    <div className='border-2 border-gray-500 w-[50%] rounded-md p-3 mt-2'>
                        <p className='font-bold text-xl'>Costo biglietto sola andata:</p>
                        <div className='flex justify-between items-center'>
                            <p className='my-2 italic'>prezzo: </p>
